...
class ProvidersSceneController implements SetupSceneController {
	title = t("setup.providers_title", "Set up your providers");
	subtitle = t("setup.providers_subtitle", "Sign in and pick a web search provider. Press Esc when you're done.");
	...
	constructor(host: SetupSceneHost) {
		...
		this.#tabBar = new TabBar(
			t("setup.providers_tab_group", "Providers"),
